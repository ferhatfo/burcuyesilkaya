...
// Her hizmet için benzersiz görsel eşleştirmeleri - kaynak klasöründeki tüm görselleri maksimum çeşitlilikle kullanarak
const imageMappings = {
...
async function processAll() {
  ...
  if (errors > 0) {
    console.log('\n⚠️  Some images could not be created from source folder.');
    console.log('For completely unique images, you may need to:');
    console.log('1. Add more source images to the folder');
    console.log('2. Download images from free stock photo sites (Unsplash, Pexels, Pixabay)');
    console.log('3. Search for: "dermatology treatment", "botox injection", "chemical peel", etc.');
  }
}
