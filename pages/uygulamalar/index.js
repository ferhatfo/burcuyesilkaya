      ...
      <div className="container mx-auto px-4 py-8 md:py-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {uygulamalar.map((category, categoryIndex) => {
            ...
            return (
              <Link key={categoryIndex} href={`/uygulamalar/${slug}`}>
                <div className="overflow-hidden cursor-pointer group">
                  ...
                  <div className="p-6 py-8 bg-gray-100 rounded-xl rounded-tl-none rounded-tr-none group-hover:bg-gray-200 transition-colors">
